...
export class AsteroidsEngine {
  ...
  private lastReportedLives = -1;
  private lastReportedLevel = -1;
  ...
  private reportStateIfChanged() {
    if (
      this.score !== this.lastReportedScore ||
      this.lives !== this.lastReportedLives ||
      this.level !== this.lastReportedLevel
    ) {
      this.lastReportedScore = this.score;
      this.lastReportedLives = this.lives;
      this.lastReportedLevel = this.level;
      this.onStateChange({ score: this.score, lives: this.lives, level: this.level });
    }
  }
